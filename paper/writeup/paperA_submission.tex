...
\end{theorem}
Proof in Appendix~\ref{app:proof}. We verify it on a synthetic SBM instance: the graph advantage rises
monotonically from $+0.007$ at $p=q$ to $+0.115$ at $p-q=0.95$, essentially $0$ at $p=q$, while the embedding
kernel stays at chance.
