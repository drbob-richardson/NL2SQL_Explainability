...
faithful re-implementation of BAGEL at matched budget (recall $+0.15$--$0.25$ across budgets, decomposing into the
semantic-mean and graph-covariance choices, each validated separately), a partial rescue of adversarial MuSiQue by
