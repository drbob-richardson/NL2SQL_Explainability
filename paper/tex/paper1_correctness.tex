...
benchmarks, two generators, and two judge providers. Judges from different providers make different errors, and an
...
Modal-query execution accuracy is $0.451$, a hard regime with ample headroom for UQ. For breadth we
also use a second generator, GPT-4.1-mini (accuracy $0.522$), and a second benchmark, Spider's
multi-table dev queries ($490$ questions over $20$ databases), generated and executed the same way.
