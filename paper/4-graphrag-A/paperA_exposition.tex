...
PageRank), mass would spread to high-degree hubs and \emph{can bury} the bridge---so the graph need not be a good
ranking signal even where it is an excellent covariance. But as a \emph{covariance} the graph is not asked to rank
anything; it is asked to say ``if this
